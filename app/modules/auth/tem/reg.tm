...
<head>
	...
	<title>DTBS Страница регистрации</title>
		...
		<div class="main container-fluid mt-3">
			<div class="row">
					<div class="table_auth">
						<h3 class="text-center mb-3">Регистрация DTBS</h3>
						<form name = "auth" action = "/app/modules/auth/Auth.php" method = "post">
							...
							<button type="submit" class = "btn btn-success mt-2" id = 'submit' name = "nameForm" value = "reg">Зарегистрироваться</button> <a href = "/" class="btn btn-success mt-2">На главную страницу</a>
...
$('#submit').click(function(){
	...
	if(name.length < 4)
		errors += "Поле имя не может быть короче 4 символов.<br />"; 
	if(pass1 < 4)
